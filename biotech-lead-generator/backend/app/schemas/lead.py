...
from app.schemas.base import BaseSchema, TimestampSchema, PaginationParams, SortParams
...
class LeadCreate(BaseModel):
    ...
    location: Optional[str] = Field(None, max_length=255, description="Personal location")
    company_hq: Optional[str] = Field(None, max_length=255, description="Company HQ location")
    
    email: Optional[EmailStr] = Field(None, description="Contact email")
    phone: Optional[str] = Field(None, max_length=50, description="Phone number")
    linkedin_url: Optional[str] = Field(None, max_length=500, description="LinkedIn profile URL")
    twitter_url: Optional[str] = Field(None, max_length=500, description="Twitter/X profile")
    website: Optional[str] = Field(None, max_length=500, description="Website")
    
    recent_publication: bool = Field(default=False, description="Has recent publication")
    publication_year: Optional[int] = Field(None, ge=1950, le=2100, description="Publication year")
    ...
    company_funding: Optional[str] = Field(None, max_length=50, description="Funding stage")
...
class LeadFilters(BaseModel):
    ...
    min_score: Optional[int] = Field(None, ge=0, le=100, description="Minimum propensity score")
    max_score: Optional[int] = Field(None, ge=0, le=100, description="Maximum propensity score")
...
class LeadBulkCreate(BaseModel):
    ...
    calculate_scores: bool = Field(default=True, description="Calculate propensity scores")
